                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('admin.discount.create')}}" class="btn btn-success mb-2 "> Add User
                            </a> <br>
                            @else
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><img alt="image" src="{{ URL::to('/' . $dt->avatar)}}"
                                                    class="rounded-circle" width="35" data-toggle="tooltip"
                                                    title="{{ $dt->name }}"></td>
                                            <td>{{ $dt->name}}</td>
                                            <td>
                                                <div class="badge badge-primary pb-2 ">{{ $dt->UserRole->role->name }}
                                                </div>
                                            </td>
                                            <td>{{ $dt->email }}</td>
                                            <td>{{ $dt->phone }}</td>
                                        ...
                                        @empty
                                        Manajement User Course Camp Belum Tersedia
                                        @endforelse
