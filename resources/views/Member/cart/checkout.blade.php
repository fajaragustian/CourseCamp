                        ...
                        <form action="{{route('member.checkout.store', $camp->id)}}" class="basic-form" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="occupation" name="occupation"
                                    placeholder="Masukan Latar Pekerjaan ">
                            </div>
                            <div class="mb-4">
                                <label for="card_number" class="form-label">Card Number</label>
                                <input type="number" class="form-control" id="card_number" name="card_number"
                                    placeholder="Masukan Card Number " maxlength="12" required>
                            </div>
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <label for="expired" class="form-label">Expired</label>
                                        <input type="month" class="form-control" id="expired" name="expired" required>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <label for="cvc" class="form-label">CVC</label>
                                        <input type="text" class="form-control" id="cvc" name="cvc"
                                            placeholder="Masukan Kode CVC Card Number" maxlength="3" required>
                                    </div>
                                </div>
                            </div>
